...
<head>
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
        href="<?php echo base_url('admin/') ?>/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url('admin/') ?>/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url('admin/') ?>/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="<?php echo base_url('admin/') ?>/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Summernote -->
    ...
    <script src="<?php echo base_url('admin/') ?>/plugins/datatables-responsive/js/dataTables.responsive.min.js">
    </script>
    <script src="<?php echo base_url('admin/') ?>/plugins/datatables-responsive/js/responsive.bootstrap4.min.js">
    </script>
