	...
	<div class="col-md-6">
		<div class="card card-success">
			...
			<div class="card-body">
				...
				<a href="<?php echo site_url("admin/usuarios/edit/$usuarios->id");?>" class="btn btn-dark btn-sm"><i
						class="fa-solid fa-pen-to-square"></i> Editar</a>
				<a href="<?php echo site_url("admin/usuarios/excluir/$usuarios->id");?>"
					class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i> Desactivar</a>
				<a href="<?php echo site_url("admin/usuarios");?>" class="btn btn-warning btn-sm"><i
						class="fa-solid fa-backward"></i> Atras</a>
			</div>
